...
{
    public class WeaselComponent : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public WeaselComponent()
          : base("newComponent", "ASpi",
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("b670fab9-8fe4-40ce-91b9-88f94d7718d0");
    }
}